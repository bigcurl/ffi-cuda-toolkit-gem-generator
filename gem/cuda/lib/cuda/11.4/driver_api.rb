...
module Cuda
  ...
  Callback_CUstreamCallback = callback(:CUstreamCallback, [ :CUstream, :CUresult, :pointer ], :void)
  ...
  CUgraphMem_attribute_enum = enum :CUgraphMem_attribute, [
    :used_mem_current,
    :used_mem_high,
    :reserved_mem_current,
    :reserved_mem_high,
  ...
  attach_function :cuGetErrorString, :cuGetErrorString, [ :CUresult, :pointer ], :CUresult
  attach_function :cuGetErrorName, :cuGetErrorName, [ :CUresult, :pointer ], :CUresult
  attach_function :cuInit, :cuInit, [ :uint ], :CUresult
  attach_function :cuDriverGetVersion, :cuDriverGetVersion, [ :pointer ], :CUresult
  attach_function :cuDeviceGet, :cuDeviceGet, [ :pointer, :int ], :CUresult
  attach_function :cuDeviceGetCount, :cuDeviceGetCount, [ :pointer ], :CUresult
  attach_function :cuDeviceGetName, :cuDeviceGetName, [ :string, :int, :CUdevice ], :CUresult
  attach_function :cuDeviceGetUuid, :cuDeviceGetUuid, [ :pointer, :CUdevice ], :CUresult
  attach_function :cuDeviceGetUuid_v2, :cuDeviceGetUuid_v2, [ :pointer, :CUdevice ], :CUresult
  attach_function :cuDeviceGetLuid, :cuDeviceGetLuid, [ :string, :pointer, :CUdevice ], :CUresult
  attach_function :cuDeviceTotalMem_v2, :cuDeviceTotalMem_v2, [ :pointer, :CUdevice ], :CUresult
  attach_function :cuDeviceGetTexture1DLinearMaxWidth, :cuDeviceGetTexture1DLinearMaxWidth, [ :pointer, :CUarray_format, :uint, :CUdevice ], :CUresult
  attach_function :cuDeviceGetAttribute, :cuDeviceGetAttribute, [ :pointer, :CUdevice_attribute, :CUdevice ], :CUresult
  attach_function :cuDeviceGetNvSciSyncAttributes, :cuDeviceGetNvSciSyncAttributes, [ :pointer, :CUdevice, :int ], :CUresult
  attach_function :cuDeviceSetMemPool, :cuDeviceSetMemPool, [ :CUdevice, :CUmemoryPool ], :CUresult
  attach_function :cuDeviceGetMemPool, :cuDeviceGetMemPool, [ :pointer, :CUdevice ], :CUresult
  attach_function :cuDeviceGetDefaultMemPool, :cuDeviceGetDefaultMemPool, [ :pointer, :CUdevice ], :CUresult
  attach_function :cuFlushGPUDirectRDMAWrites, :cuFlushGPUDirectRDMAWrites, [ :CUflushGPUDirectRDMAWritesTarget, :CUflushGPUDirectRDMAWritesScope ], :CUresult
  attach_function :cuDeviceGetProperties, :cuDeviceGetProperties, [ :pointer, :CUdevice ], :CUresult
  attach_function :cuDeviceComputeCapability, :cuDeviceComputeCapability, [ :pointer, :pointer, :CUdevice ], :CUresult
  attach_function :cuDevicePrimaryCtxRetain, :cuDevicePrimaryCtxRetain, [ :pointer, :CUdevice ], :CUresult
  attach_function :cuDevicePrimaryCtxRelease_v2, :cuDevicePrimaryCtxRelease_v2, [ :CUdevice ], :CUresult
  attach_function :cuDevicePrimaryCtxSetFlags_v2, :cuDevicePrimaryCtxSetFlags_v2, [ :CUdevice, :uint ], :CUresult
  attach_function :cuDevicePrimaryCtxGetState, :cuDevicePrimaryCtxGetState, [ :CUdevice, :pointer, :pointer ], :CUresult
  attach_function :cuDevicePrimaryCtxReset_v2, :cuDevicePrimaryCtxReset_v2, [ :CUdevice ], :CUresult
  attach_function :cuDeviceGetExecAffinitySupport, :cuDeviceGetExecAffinitySupport, [ :pointer, :CUexecAffinityType, :CUdevice ], :CUresult
  attach_function :cuCtxCreate_v2, :cuCtxCreate_v2, [ :pointer, :uint, :CUdevice ], :CUresult
  attach_function :cuCtxCreate_v3, :cuCtxCreate_v3, [ :pointer, :pointer, :int, :uint, :CUdevice ], :CUresult
  ...
  attach_function :cuCtxSetLimit, :cuCtxSetLimit, [ :CUlimit, :size_t ], :CUresult
  attach_function :cuCtxGetLimit, :cuCtxGetLimit, [ :pointer, :CUlimit ], :CUresult
  ...
  attach_function :cuCtxGetApiVersion, :cuCtxGetApiVersion, [ :CUcontext, :pointer ], :CUresult
  attach_function :cuCtxGetStreamPriorityRange, :cuCtxGetStreamPriorityRange, [ :pointer, :pointer ], :CUresult
  attach_function :cuCtxResetPersistingL2Cache, :cuCtxResetPersistingL2Cache, [  ], :CUresult
  attach_function :cuCtxGetExecAffinity, :cuCtxGetExecAffinity, [ :pointer, :CUexecAffinityType ], :CUresult
  attach_function :cuCtxAttach, :cuCtxAttach, [ :pointer, :uint ], :CUresult
  attach_function :cuCtxDetach, :cuCtxDetach, [ :CUcontext ], :CUresult
  attach_function :cuModuleLoad, :cuModuleLoad, [ :pointer, :string ], :CUresult
  attach_function :cuModuleLoadData, :cuModuleLoadData, [ :pointer, :pointer ], :CUresult
  attach_function :cuModuleLoadDataEx, :cuModuleLoadDataEx, [ :pointer, :pointer, :uint, :pointer, :pointer ], :CUresult
  attach_function :cuModuleLoadFatBinary, :cuModuleLoadFatBinary, [ :pointer, :pointer ], :CUresult
  attach_function :cuModuleUnload, :cuModuleUnload, [ :CUmodule ], :CUresult
  attach_function :cuModuleGetFunction, :cuModuleGetFunction, [ :pointer, :CUmodule, :string ], :CUresult
  attach_function :cuModuleGetGlobal_v2, :cuModuleGetGlobal_v2, [ :pointer, :pointer, :CUmodule, :string ], :CUresult
  attach_function :cuModuleGetTexRef, :cuModuleGetTexRef, [ :pointer, :CUmodule, :string ], :CUresult
  attach_function :cuModuleGetSurfRef, :cuModuleGetSurfRef, [ :pointer, :CUmodule, :string ], :CUresult
  attach_function :cuLinkCreate_v2, :cuLinkCreate_v2, [ :uint, :pointer, :pointer, :pointer ], :CUresult
  attach_function :cuLinkAddData_v2, :cuLinkAddData_v2, [ :CUlinkState, :CUjitInputType, :pointer, :size_t, :string, :uint, :pointer, :pointer ], :CUresult
  attach_function :cuLinkAddFile_v2, :cuLinkAddFile_v2, [ :CUlinkState, :CUjitInputType, :string, :uint, :pointer, :pointer ], :CUresult
  attach_function :cuLinkComplete, :cuLinkComplete, [ :CUlinkState, :pointer, :pointer ], :CUresult
  attach_function :cuLinkDestroy, :cuLinkDestroy, [ :CUlinkState ], :CUresult
  attach_function :cuMemGetInfo_v2, :cuMemGetInfo_v2, [ :pointer, :pointer ], :CUresult
  attach_function :cuMemAlloc_v2, :cuMemAlloc_v2, [ :pointer, :size_t ], :CUresult
  attach_function :cuMemAllocPitch_v2, :cuMemAllocPitch_v2, [ :pointer, :pointer, :size_t, :size_t, :uint ], :CUresult
  attach_function :cuMemFree_v2, :cuMemFree_v2, [ :CUdeviceptr ], :CUresult
  attach_function :cuMemGetAddressRange_v2, :cuMemGetAddressRange_v2, [ :pointer, :pointer, :CUdeviceptr ], :CUresult
  attach_function :cuMemAllocHost_v2, :cuMemAllocHost_v2, [ :pointer, :size_t ], :CUresult
  attach_function :cuMemFreeHost, :cuMemFreeHost, [ :pointer ], :CUresult
  attach_function :cuMemHostAlloc, :cuMemHostAlloc, [ :pointer, :size_t, :uint ], :CUresult
  attach_function :cuMemHostGetDevicePointer_v2, :cuMemHostGetDevicePointer_v2, [ :pointer, :pointer, :uint ], :CUresult
  attach_function :cuMemHostGetFlags, :cuMemHostGetFlags, [ :pointer, :pointer ], :CUresult
  attach_function :cuMemAllocManaged, :cuMemAllocManaged, [ :pointer, :size_t, :uint ], :CUresult
  attach_function :cuDeviceGetByPCIBusId, :cuDeviceGetByPCIBusId, [ :pointer, :string ], :CUresult
  attach_function :cuDeviceGetPCIBusId, :cuDeviceGetPCIBusId, [ :string, :int, :CUdevice ], :CUresult
  attach_function :cuIpcGetEventHandle, :cuIpcGetEventHandle, [ :pointer, :CUevent ], :CUresult
  attach_function :cuIpcOpenEventHandle, :cuIpcOpenEventHandle, [ :pointer, :CUipcEventHandle ], :CUresult
  attach_function :cuIpcGetMemHandle, :cuIpcGetMemHandle, [ :pointer, :CUdeviceptr ], :CUresult
  attach_function :cuIpcOpenMemHandle_v2, :cuIpcOpenMemHandle_v2, [ :pointer, :CUipcMemHandle, :uint ], :CUresult
  attach_function :cuIpcCloseMemHandle, :cuIpcCloseMemHandle, [ :CUdeviceptr ], :CUresult
  attach_function :cuMemHostRegister_v2, :cuMemHostRegister_v2, [ :pointer, :size_t, :uint ], :CUresult
  attach_function :cuMemHostUnregister, :cuMemHostUnregister, [ :pointer ], :CUresult
  attach_function :cuMemcpy, :cuMemcpy, [ :CUdeviceptr, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuMemcpyPeer, :cuMemcpyPeer, [ :CUdeviceptr, :CUcontext, :CUdeviceptr, :CUcontext, :size_t ], :CUresult
  attach_function :cuMemcpyHtoD_v2, :cuMemcpyHtoD_v2, [ :CUdeviceptr, :pointer, :size_t ], :CUresult
  attach_function :cuMemcpyDtoH_v2, :cuMemcpyDtoH_v2, [ :pointer, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuMemcpyDtoD_v2, :cuMemcpyDtoD_v2, [ :CUdeviceptr, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuMemcpyDtoA_v2, :cuMemcpyDtoA_v2, [ :CUarray, :size_t, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuMemcpyAtoD_v2, :cuMemcpyAtoD_v2, [ :CUdeviceptr, :CUarray, :size_t, :size_t ], :CUresult
  attach_function :cuMemcpyHtoA_v2, :cuMemcpyHtoA_v2, [ :CUarray, :size_t, :pointer, :size_t ], :CUresult
  attach_function :cuMemcpyAtoH_v2, :cuMemcpyAtoH_v2, [ :pointer, :CUarray, :size_t, :size_t ], :CUresult
  attach_function :cuMemcpyAtoA_v2, :cuMemcpyAtoA_v2, [ :CUarray, :size_t, :CUarray, :size_t, :size_t ], :CUresult
  ...
  attach_function :cuMemcpyAsync, :cuMemcpyAsync, [ :CUdeviceptr, :CUdeviceptr, :size_t, :CUstream ], :CUresult
  attach_function :cuMemcpyPeerAsync, :cuMemcpyPeerAsync, [ :CUdeviceptr, :CUcontext, :CUdeviceptr, :CUcontext, :size_t, :CUstream ], :CUresult
  attach_function :cuMemcpyHtoDAsync_v2, :cuMemcpyHtoDAsync_v2, [ :CUdeviceptr, :pointer, :size_t, :CUstream ], :CUresult
  attach_function :cuMemcpyDtoHAsync_v2, :cuMemcpyDtoHAsync_v2, [ :pointer, :CUdeviceptr, :size_t, :CUstream ], :CUresult
  attach_function :cuMemcpyDtoDAsync_v2, :cuMemcpyDtoDAsync_v2, [ :CUdeviceptr, :CUdeviceptr, :size_t, :CUstream ], :CUresult
  attach_function :cuMemcpyHtoAAsync_v2, :cuMemcpyHtoAAsync_v2, [ :CUarray, :size_t, :pointer, :size_t, :CUstream ], :CUresult
  attach_function :cuMemcpyAtoHAsync_v2, :cuMemcpyAtoHAsync_v2, [ :pointer, :CUarray, :size_t, :size_t, :CUstream ], :CUresult
  attach_function :cuMemcpy2DAsync_v2, :cuMemcpy2DAsync_v2, [ :pointer, :CUstream ], :CUresult
  attach_function :cuMemcpy3DAsync_v2, :cuMemcpy3DAsync_v2, [ :pointer, :CUstream ], :CUresult
  attach_function :cuMemcpy3DPeerAsync, :cuMemcpy3DPeerAsync, [ :pointer, :CUstream ], :CUresult
  attach_function :cuMemsetD8_v2, :cuMemsetD8_v2, [ :CUdeviceptr, :uchar, :size_t ], :CUresult
  attach_function :cuMemsetD16_v2, :cuMemsetD16_v2, [ :CUdeviceptr, :ushort, :size_t ], :CUresult
  attach_function :cuMemsetD32_v2, :cuMemsetD32_v2, [ :CUdeviceptr, :uint, :size_t ], :CUresult
  attach_function :cuMemsetD2D8_v2, :cuMemsetD2D8_v2, [ :CUdeviceptr, :size_t, :uchar, :size_t, :size_t ], :CUresult
  attach_function :cuMemsetD2D16_v2, :cuMemsetD2D16_v2, [ :CUdeviceptr, :size_t, :ushort, :size_t, :size_t ], :CUresult
  attach_function :cuMemsetD2D32_v2, :cuMemsetD2D32_v2, [ :CUdeviceptr, :size_t, :uint, :size_t, :size_t ], :CUresult
  attach_function :cuMemsetD8Async, :cuMemsetD8Async, [ :CUdeviceptr, :uchar, :size_t, :CUstream ], :CUresult
  attach_function :cuMemsetD16Async, :cuMemsetD16Async, [ :CUdeviceptr, :ushort, :size_t, :CUstream ], :CUresult
  attach_function :cuMemsetD32Async, :cuMemsetD32Async, [ :CUdeviceptr, :uint, :size_t, :CUstream ], :CUresult
  attach_function :cuMemsetD2D8Async, :cuMemsetD2D8Async, [ :CUdeviceptr, :size_t, :uchar, :size_t, :size_t, :CUstream ], :CUresult
  attach_function :cuMemsetD2D16Async, :cuMemsetD2D16Async, [ :CUdeviceptr, :size_t, :ushort, :size_t, :size_t, :CUstream ], :CUresult
  attach_function :cuMemsetD2D32Async, :cuMemsetD2D32Async, [ :CUdeviceptr, :size_t, :uint, :size_t, :size_t, :CUstream ], :CUresult
  attach_function :cuArrayCreate_v2, :cuArrayCreate_v2, [ :pointer, :pointer ], :CUresult
  attach_function :cuArrayGetDescriptor_v2, :cuArrayGetDescriptor_v2, [ :pointer, :CUarray ], :CUresult
  attach_function :cuArrayGetSparseProperties, :cuArrayGetSparseProperties, [ :pointer, :CUarray ], :CUresult
  attach_function :cuMipmappedArrayGetSparseProperties, :cuMipmappedArrayGetSparseProperties, [ :pointer, :CUmipmappedArray ], :CUresult
  attach_function :cuArrayGetPlane, :cuArrayGetPlane, [ :pointer, :CUarray, :uint ], :CUresult
  attach_function :cuArrayDestroy, :cuArrayDestroy, [ :CUarray ], :CUresult
  attach_function :cuArray3DCreate_v2, :cuArray3DCreate_v2, [ :pointer, :pointer ], :CUresult
  attach_function :cuArray3DGetDescriptor_v2, :cuArray3DGetDescriptor_v2, [ :pointer, :CUarray ], :CUresult
  attach_function :cuMipmappedArrayCreate, :cuMipmappedArrayCreate, [ :pointer, :pointer, :uint ], :CUresult
  attach_function :cuMipmappedArrayGetLevel, :cuMipmappedArrayGetLevel, [ :pointer, :CUmipmappedArray, :uint ], :CUresult
  attach_function :cuMipmappedArrayDestroy, :cuMipmappedArrayDestroy, [ :CUmipmappedArray ], :CUresult
  attach_function :cuMemAddressReserve, :cuMemAddressReserve, [ :pointer, :size_t, :size_t, :CUdeviceptr, :ulong_long ], :CUresult
  attach_function :cuMemAddressFree, :cuMemAddressFree, [ :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuMemCreate, :cuMemCreate, [ :pointer, :size_t, :pointer, :ulong_long ], :CUresult
  attach_function :cuMemRelease, :cuMemRelease, [ :CUmemGenericAllocationHandle ], :CUresult
  attach_function :cuMemMap, :cuMemMap, [ :CUdeviceptr, :size_t, :size_t, :CUmemGenericAllocationHandle, :ulong_long ], :CUresult
  attach_function :cuMemMapArrayAsync, :cuMemMapArrayAsync, [ :pointer, :uint, :CUstream ], :CUresult
  attach_function :cuMemUnmap, :cuMemUnmap, [ :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuMemSetAccess, :cuMemSetAccess, [ :CUdeviceptr, :size_t, :pointer, :size_t ], :CUresult
  attach_function :cuMemGetAccess, :cuMemGetAccess, [ :pointer, :pointer, :CUdeviceptr ], :CUresult
  attach_function :cuMemExportToShareableHandle, :cuMemExportToShareableHandle, [ :pointer, :CUmemGenericAllocationHandle, :CUmemAllocationHandleType, :ulong_long ], :CUresult
  attach_function :cuMemImportFromShareableHandle, :cuMemImportFromShareableHandle, [ :pointer, :pointer, :CUmemAllocationHandleType ], :CUresult
  attach_function :cuMemGetAllocationGranularity, :cuMemGetAllocationGranularity, [ :pointer, :pointer, :CUmemAllocationGranularity_flags ], :CUresult
  attach_function :cuMemGetAllocationPropertiesFromHandle, :cuMemGetAllocationPropertiesFromHandle, [ :pointer, :CUmemGenericAllocationHandle ], :CUresult
  attach_function :cuMemRetainAllocationHandle, :cuMemRetainAllocationHandle, [ :pointer, :pointer ], :CUresult
  attach_function :cuMemFreeAsync, :cuMemFreeAsync, [ :CUdeviceptr, :CUstream ], :CUresult
  attach_function :cuMemAllocAsync, :cuMemAllocAsync, [ :pointer, :size_t, :CUstream ], :CUresult
  attach_function :cuMemPoolTrimTo, :cuMemPoolTrimTo, [ :CUmemoryPool, :size_t ], :CUresult
  attach_function :cuMemPoolSetAttribute, :cuMemPoolSetAttribute, [ :CUmemoryPool, :CUmemPool_attribute, :pointer ], :CUresult
  attach_function :cuMemPoolGetAttribute, :cuMemPoolGetAttribute, [ :CUmemoryPool, :CUmemPool_attribute, :pointer ], :CUresult
  attach_function :cuMemPoolSetAccess, :cuMemPoolSetAccess, [ :CUmemoryPool, :pointer, :size_t ], :CUresult
  attach_function :cuMemPoolGetAccess, :cuMemPoolGetAccess, [ :pointer, :CUmemoryPool, :pointer ], :CUresult
  attach_function :cuMemPoolCreate, :cuMemPoolCreate, [ :pointer, :pointer ], :CUresult
  attach_function :cuMemPoolDestroy, :cuMemPoolDestroy, [ :CUmemoryPool ], :CUresult
  attach_function :cuMemAllocFromPoolAsync, :cuMemAllocFromPoolAsync, [ :pointer, :size_t, :CUmemoryPool, :CUstream ], :CUresult
  attach_function :cuMemPoolExportToShareableHandle, :cuMemPoolExportToShareableHandle, [ :pointer, :CUmemoryPool, :CUmemAllocationHandleType, :ulong_long ], :CUresult
  attach_function :cuMemPoolImportFromShareableHandle, :cuMemPoolImportFromShareableHandle, [ :pointer, :pointer, :CUmemAllocationHandleType, :ulong_long ], :CUresult
  attach_function :cuMemPoolExportPointer, :cuMemPoolExportPointer, [ :pointer, :CUdeviceptr ], :CUresult
  attach_function :cuMemPoolImportPointer, :cuMemPoolImportPointer, [ :pointer, :CUmemoryPool, :pointer ], :CUresult
  attach_function :cuPointerGetAttribute, :cuPointerGetAttribute, [ :pointer, :CUpointer_attribute, :CUdeviceptr ], :CUresult
  attach_function :cuMemPrefetchAsync, :cuMemPrefetchAsync, [ :CUdeviceptr, :size_t, :CUdevice, :CUstream ], :CUresult
  attach_function :cuMemAdvise, :cuMemAdvise, [ :CUdeviceptr, :size_t, :CUmem_advise, :CUdevice ], :CUresult
  attach_function :cuMemRangeGetAttribute, :cuMemRangeGetAttribute, [ :pointer, :size_t, :CUmem_range_attribute, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuMemRangeGetAttributes, :cuMemRangeGetAttributes, [ :pointer, :pointer, :pointer, :size_t, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuPointerSetAttribute, :cuPointerSetAttribute, [ :pointer, :CUpointer_attribute, :CUdeviceptr ], :CUresult
  attach_function :cuPointerGetAttributes, :cuPointerGetAttributes, [ :uint, :pointer, :pointer, :CUdeviceptr ], :CUresult
  attach_function :cuStreamCreate, :cuStreamCreate, [ :pointer, :uint ], :CUresult
  attach_function :cuStreamCreateWithPriority, :cuStreamCreateWithPriority, [ :pointer, :uint, :int ], :CUresult
  attach_function :cuStreamGetPriority, :cuStreamGetPriority, [ :CUstream, :pointer ], :CUresult
  attach_function :cuStreamGetFlags, :cuStreamGetFlags, [ :CUstream, :pointer ], :CUresult
  attach_function :cuStreamGetCtx, :cuStreamGetCtx, [ :CUstream, :pointer ], :CUresult
  attach_function :cuStreamWaitEvent, :cuStreamWaitEvent, [ :CUstream, :CUevent, :uint ], :CUresult
  attach_function :cuStreamAddCallback, :cuStreamAddCallback, [ :CUstream, Callback_CUstreamCallback, :pointer, :uint ], :CUresult
  attach_function :cuStreamBeginCapture_v2, :cuStreamBeginCapture_v2, [ :CUstream, :CUstreamCaptureMode ], :CUresult
  attach_function :cuThreadExchangeStreamCaptureMode, :cuThreadExchangeStreamCaptureMode, [ :pointer ], :CUresult
  attach_function :cuStreamEndCapture, :cuStreamEndCapture, [ :CUstream, :pointer ], :CUresult
  attach_function :cuStreamIsCapturing, :cuStreamIsCapturing, [ :CUstream, :pointer ], :CUresult
  attach_function :cuStreamGetCaptureInfo, :cuStreamGetCaptureInfo, [ :CUstream, :pointer, :pointer ], :CUresult
  attach_function :cuStreamGetCaptureInfo_v2, :cuStreamGetCaptureInfo_v2, [ :CUstream, :pointer, :pointer, :pointer, :pointer, :pointer ], :CUresult
  attach_function :cuStreamUpdateCaptureDependencies, :cuStreamUpdateCaptureDependencies, [ :CUstream, :pointer, :size_t, :uint ], :CUresult
  attach_function :cuStreamAttachMemAsync, :cuStreamAttachMemAsync, [ :CUstream, :CUdeviceptr, :size_t, :uint ], :CUresult
  ...
  attach_function :cuStreamCopyAttributes, :cuStreamCopyAttributes, [ :CUstream, :CUstream ], :CUresult
  attach_function :cuStreamGetAttribute, :cuStreamGetAttribute, [ :CUstream, :CUstreamAttrID, :pointer ], :CUresult
  attach_function :cuStreamSetAttribute, :cuStreamSetAttribute, [ :CUstream, :CUstreamAttrID, :pointer ], :CUresult
  attach_function :cuEventCreate, :cuEventCreate, [ :pointer, :uint ], :CUresult
  attach_function :cuEventRecord, :cuEventRecord, [ :CUevent, :CUstream ], :CUresult
  attach_function :cuEventRecordWithFlags, :cuEventRecordWithFlags, [ :CUevent, :CUstream, :uint ], :CUresult
  ...
  attach_function :cuEventElapsedTime, :cuEventElapsedTime, [ :pointer, :CUevent, :CUevent ], :CUresult
  attach_function :cuImportExternalMemory, :cuImportExternalMemory, [ :pointer, :pointer ], :CUresult
  attach_function :cuExternalMemoryGetMappedBuffer, :cuExternalMemoryGetMappedBuffer, [ :pointer, :CUexternalMemory, :pointer ], :CUresult
  attach_function :cuExternalMemoryGetMappedMipmappedArray, :cuExternalMemoryGetMappedMipmappedArray, [ :pointer, :CUexternalMemory, :pointer ], :CUresult
  attach_function :cuDestroyExternalMemory, :cuDestroyExternalMemory, [ :CUexternalMemory ], :CUresult
  attach_function :cuImportExternalSemaphore, :cuImportExternalSemaphore, [ :pointer, :pointer ], :CUresult
  attach_function :cuSignalExternalSemaphoresAsync, :cuSignalExternalSemaphoresAsync, [ :pointer, :pointer, :uint, :CUstream ], :CUresult
  attach_function :cuWaitExternalSemaphoresAsync, :cuWaitExternalSemaphoresAsync, [ :pointer, :pointer, :uint, :CUstream ], :CUresult
  attach_function :cuDestroyExternalSemaphore, :cuDestroyExternalSemaphore, [ :CUexternalSemaphore ], :CUresult
  attach_function :cuStreamWaitValue32, :cuStreamWaitValue32, [ :CUstream, :CUdeviceptr, :cuuint32_t, :uint ], :CUresult
  attach_function :cuStreamWaitValue64, :cuStreamWaitValue64, [ :CUstream, :CUdeviceptr, :cuuint64_t, :uint ], :CUresult
  attach_function :cuStreamWriteValue32, :cuStreamWriteValue32, [ :CUstream, :CUdeviceptr, :cuuint32_t, :uint ], :CUresult
  attach_function :cuStreamWriteValue64, :cuStreamWriteValue64, [ :CUstream, :CUdeviceptr, :cuuint64_t, :uint ], :CUresult
  attach_function :cuStreamBatchMemOp, :cuStreamBatchMemOp, [ :CUstream, :uint, :pointer, :uint ], :CUresult
  attach_function :cuFuncGetAttribute, :cuFuncGetAttribute, [ :pointer, :CUfunction_attribute, :CUfunction ], :CUresult
  attach_function :cuFuncSetAttribute, :cuFuncSetAttribute, [ :CUfunction, :CUfunction_attribute, :int ], :CUresult
  attach_function :cuFuncSetCacheConfig, :cuFuncSetCacheConfig, [ :CUfunction, :CUfunc_cache ], :CUresult
  attach_function :cuFuncSetSharedMemConfig, :cuFuncSetSharedMemConfig, [ :CUfunction, :CUsharedconfig ], :CUresult
  attach_function :cuFuncGetModule, :cuFuncGetModule, [ :pointer, :CUfunction ], :CUresult
  attach_function :cuLaunchKernel, :cuLaunchKernel, [ :CUfunction, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :CUstream, :pointer, :pointer ], :CUresult
  attach_function :cuLaunchCooperativeKernel, :cuLaunchCooperativeKernel, [ :CUfunction, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :CUstream, :pointer ], :CUresult
  attach_function :cuLaunchCooperativeKernelMultiDevice, :cuLaunchCooperativeKernelMultiDevice, [ :pointer, :uint, :uint ], :CUresult
  attach_function :cuLaunchHostFunc, :cuLaunchHostFunc, [ :CUstream, Callback_CUhostFn, :pointer ], :CUresult
  attach_function :cuFuncSetBlockShape, :cuFuncSetBlockShape, [ :CUfunction, :int, :int, :int ], :CUresult
  attach_function :cuFuncSetSharedSize, :cuFuncSetSharedSize, [ :CUfunction, :uint ], :CUresult
  attach_function :cuParamSetSize, :cuParamSetSize, [ :CUfunction, :uint ], :CUresult
  attach_function :cuParamSeti, :cuParamSeti, [ :CUfunction, :int, :uint ], :CUresult
  attach_function :cuParamSetf, :cuParamSetf, [ :CUfunction, :int, :float ], :CUresult
  attach_function :cuParamSetv, :cuParamSetv, [ :CUfunction, :int, :pointer, :uint ], :CUresult
  attach_function :cuLaunch, :cuLaunch, [ :CUfunction ], :CUresult
  attach_function :cuLaunchGrid, :cuLaunchGrid, [ :CUfunction, :int, :int ], :CUresult
  attach_function :cuLaunchGridAsync, :cuLaunchGridAsync, [ :CUfunction, :int, :int, :CUstream ], :CUresult
  attach_function :cuParamSetTexRef, :cuParamSetTexRef, [ :CUfunction, :int, :CUtexref ], :CUresult
  attach_function :cuGraphCreate, :cuGraphCreate, [ :pointer, :uint ], :CUresult
  attach_function :cuGraphAddKernelNode, :cuGraphAddKernelNode, [ :pointer, :CUgraph, :pointer, :size_t, :pointer ], :CUresult
  attach_function :cuGraphKernelNodeGetParams, :cuGraphKernelNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphKernelNodeSetParams, :cuGraphKernelNodeSetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddMemcpyNode, :cuGraphAddMemcpyNode, [ :pointer, :CUgraph, :pointer, :size_t, :pointer, :CUcontext ], :CUresult
  attach_function :cuGraphMemcpyNodeGetParams, :cuGraphMemcpyNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphMemcpyNodeSetParams, :cuGraphMemcpyNodeSetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddMemsetNode, :cuGraphAddMemsetNode, [ :pointer, :CUgraph, :pointer, :size_t, :pointer, :CUcontext ], :CUresult
  attach_function :cuGraphMemsetNodeGetParams, :cuGraphMemsetNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphMemsetNodeSetParams, :cuGraphMemsetNodeSetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddHostNode, :cuGraphAddHostNode, [ :pointer, :CUgraph, :pointer, :size_t, :pointer ], :CUresult
  attach_function :cuGraphHostNodeGetParams, :cuGraphHostNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphHostNodeSetParams, :cuGraphHostNodeSetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddChildGraphNode, :cuGraphAddChildGraphNode, [ :pointer, :CUgraph, :pointer, :size_t, :CUgraph ], :CUresult
  attach_function :cuGraphChildGraphNodeGetGraph, :cuGraphChildGraphNodeGetGraph, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddEmptyNode, :cuGraphAddEmptyNode, [ :pointer, :CUgraph, :pointer, :size_t ], :CUresult
  attach_function :cuGraphAddEventRecordNode, :cuGraphAddEventRecordNode, [ :pointer, :CUgraph, :pointer, :size_t, :CUevent ], :CUresult
  attach_function :cuGraphEventRecordNodeGetEvent, :cuGraphEventRecordNodeGetEvent, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphEventRecordNodeSetEvent, :cuGraphEventRecordNodeSetEvent, [ :CUgraphNode, :CUevent ], :CUresult
  attach_function :cuGraphAddEventWaitNode, :cuGraphAddEventWaitNode, [ :pointer, :CUgraph, :pointer, :size_t, :CUevent ], :CUresult
  attach_function :cuGraphEventWaitNodeGetEvent, :cuGraphEventWaitNodeGetEvent, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphEventWaitNodeSetEvent, :cuGraphEventWaitNodeSetEvent, [ :CUgraphNode, :CUevent ], :CUresult
  attach_function :cuGraphAddExternalSemaphoresSignalNode, :cuGraphAddExternalSemaphoresSignalNode, [ :pointer, :CUgraph, :pointer, :size_t, :pointer ], :CUresult
  attach_function :cuGraphExternalSemaphoresSignalNodeGetParams, :cuGraphExternalSemaphoresSignalNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphExternalSemaphoresSignalNodeSetParams, :cuGraphExternalSemaphoresSignalNodeSetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddExternalSemaphoresWaitNode, :cuGraphAddExternalSemaphoresWaitNode, [ :pointer, :CUgraph, :pointer, :size_t, :pointer ], :CUresult
  attach_function :cuGraphExternalSemaphoresWaitNodeGetParams, :cuGraphExternalSemaphoresWaitNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphExternalSemaphoresWaitNodeSetParams, :cuGraphExternalSemaphoresWaitNodeSetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddMemAllocNode, :cuGraphAddMemAllocNode, [ :pointer, :CUgraph, :pointer, :size_t, :pointer ], :CUresult
  attach_function :cuGraphMemAllocNodeGetParams, :cuGraphMemAllocNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphAddMemFreeNode, :cuGraphAddMemFreeNode, [ :pointer, :CUgraph, :pointer, :size_t, :CUdeviceptr ], :CUresult
  attach_function :cuGraphMemFreeNodeGetParams, :cuGraphMemFreeNodeGetParams, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuDeviceGraphMemTrim, :cuDeviceGraphMemTrim, [ :CUdevice ], :CUresult
  attach_function :cuDeviceGetGraphMemAttribute, :cuDeviceGetGraphMemAttribute, [ :CUdevice, :CUgraphMem_attribute, :pointer ], :CUresult
  attach_function :cuDeviceSetGraphMemAttribute, :cuDeviceSetGraphMemAttribute, [ :CUdevice, :CUgraphMem_attribute, :pointer ], :CUresult
  attach_function :cuGraphClone, :cuGraphClone, [ :pointer, :CUgraph ], :CUresult
  attach_function :cuGraphNodeFindInClone, :cuGraphNodeFindInClone, [ :pointer, :CUgraphNode, :CUgraph ], :CUresult
  attach_function :cuGraphNodeGetType, :cuGraphNodeGetType, [ :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphGetNodes, :cuGraphGetNodes, [ :CUgraph, :pointer, :pointer ], :CUresult
  attach_function :cuGraphGetRootNodes, :cuGraphGetRootNodes, [ :CUgraph, :pointer, :pointer ], :CUresult
  attach_function :cuGraphGetEdges, :cuGraphGetEdges, [ :CUgraph, :pointer, :pointer, :pointer ], :CUresult
  attach_function :cuGraphNodeGetDependencies, :cuGraphNodeGetDependencies, [ :CUgraphNode, :pointer, :pointer ], :CUresult
  attach_function :cuGraphNodeGetDependentNodes, :cuGraphNodeGetDependentNodes, [ :CUgraphNode, :pointer, :pointer ], :CUresult
  attach_function :cuGraphAddDependencies, :cuGraphAddDependencies, [ :CUgraph, :pointer, :pointer, :size_t ], :CUresult
  attach_function :cuGraphRemoveDependencies, :cuGraphRemoveDependencies, [ :CUgraph, :pointer, :pointer, :size_t ], :CUresult
  attach_function :cuGraphDestroyNode, :cuGraphDestroyNode, [ :CUgraphNode ], :CUresult
  attach_function :cuGraphInstantiate_v2, :cuGraphInstantiate_v2, [ :pointer, :CUgraph, :pointer, :string, :size_t ], :CUresult
  attach_function :cuGraphInstantiateWithFlags, :cuGraphInstantiateWithFlags, [ :pointer, :CUgraph, :ulong_long ], :CUresult
  attach_function :cuGraphExecKernelNodeSetParams, :cuGraphExecKernelNodeSetParams, [ :CUgraphExec, :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphExecMemcpyNodeSetParams, :cuGraphExecMemcpyNodeSetParams, [ :CUgraphExec, :CUgraphNode, :pointer, :CUcontext ], :CUresult
  attach_function :cuGraphExecMemsetNodeSetParams, :cuGraphExecMemsetNodeSetParams, [ :CUgraphExec, :CUgraphNode, :pointer, :CUcontext ], :CUresult
  attach_function :cuGraphExecHostNodeSetParams, :cuGraphExecHostNodeSetParams, [ :CUgraphExec, :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphExecChildGraphNodeSetParams, :cuGraphExecChildGraphNodeSetParams, [ :CUgraphExec, :CUgraphNode, :CUgraph ], :CUresult
  attach_function :cuGraphExecEventRecordNodeSetEvent, :cuGraphExecEventRecordNodeSetEvent, [ :CUgraphExec, :CUgraphNode, :CUevent ], :CUresult
  attach_function :cuGraphExecEventWaitNodeSetEvent, :cuGraphExecEventWaitNodeSetEvent, [ :CUgraphExec, :CUgraphNode, :CUevent ], :CUresult
  attach_function :cuGraphExecExternalSemaphoresSignalNodeSetParams, :cuGraphExecExternalSemaphoresSignalNodeSetParams, [ :CUgraphExec, :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphExecExternalSemaphoresWaitNodeSetParams, :cuGraphExecExternalSemaphoresWaitNodeSetParams, [ :CUgraphExec, :CUgraphNode, :pointer ], :CUresult
  attach_function :cuGraphUpload, :cuGraphUpload, [ :CUgraphExec, :CUstream ], :CUresult
  attach_function :cuGraphLaunch, :cuGraphLaunch, [ :CUgraphExec, :CUstream ], :CUresult
  ...
  attach_function :cuGraphExecUpdate, :cuGraphExecUpdate, [ :CUgraphExec, :CUgraph, :pointer, :pointer ], :CUresult
  attach_function :cuGraphKernelNodeCopyAttributes, :cuGraphKernelNodeCopyAttributes, [ :CUgraphNode, :CUgraphNode ], :CUresult
  attach_function :cuGraphKernelNodeGetAttribute, :cuGraphKernelNodeGetAttribute, [ :CUgraphNode, :CUkernelNodeAttrID, :pointer ], :CUresult
  attach_function :cuGraphKernelNodeSetAttribute, :cuGraphKernelNodeSetAttribute, [ :CUgraphNode, :CUkernelNodeAttrID, :pointer ], :CUresult
  attach_function :cuGraphDebugDotPrint, :cuGraphDebugDotPrint, [ :CUgraph, :string, :uint ], :CUresult
  attach_function :cuUserObjectCreate, :cuUserObjectCreate, [ :pointer, :pointer, Callback_CUhostFn, :uint, :uint ], :CUresult
  attach_function :cuUserObjectRetain, :cuUserObjectRetain, [ :CUuserObject, :uint ], :CUresult
  attach_function :cuUserObjectRelease, :cuUserObjectRelease, [ :CUuserObject, :uint ], :CUresult
  attach_function :cuGraphRetainUserObject, :cuGraphRetainUserObject, [ :CUgraph, :CUuserObject, :uint, :uint ], :CUresult
  attach_function :cuGraphReleaseUserObject, :cuGraphReleaseUserObject, [ :CUgraph, :CUuserObject, :uint ], :CUresult
  attach_function :cuOccupancyMaxActiveBlocksPerMultiprocessor, :cuOccupancyMaxActiveBlocksPerMultiprocessor, [ :pointer, :CUfunction, :int, :size_t ], :CUresult
  attach_function :cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags, :cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags, [ :pointer, :CUfunction, :int, :size_t, :uint ], :CUresult
  ...
  attach_function :cuOccupancyAvailableDynamicSMemPerBlock, :cuOccupancyAvailableDynamicSMemPerBlock, [ :pointer, :CUfunction, :int, :int ], :CUresult
  attach_function :cuTexRefSetArray, :cuTexRefSetArray, [ :CUtexref, :CUarray, :uint ], :CUresult
  attach_function :cuTexRefSetMipmappedArray, :cuTexRefSetMipmappedArray, [ :CUtexref, :CUmipmappedArray, :uint ], :CUresult
  attach_function :cuTexRefSetAddress_v2, :cuTexRefSetAddress_v2, [ :pointer, :CUtexref, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuTexRefSetAddress2D_v3, :cuTexRefSetAddress2D_v3, [ :CUtexref, :pointer, :CUdeviceptr, :size_t ], :CUresult
  attach_function :cuTexRefSetFormat, :cuTexRefSetFormat, [ :CUtexref, :CUarray_format, :int ], :CUresult
  attach_function :cuTexRefSetAddressMode, :cuTexRefSetAddressMode, [ :CUtexref, :int, :CUaddress_mode ], :CUresult
  attach_function :cuTexRefSetFilterMode, :cuTexRefSetFilterMode, [ :CUtexref, :CUfilter_mode ], :CUresult
  attach_function :cuTexRefSetMipmapFilterMode, :cuTexRefSetMipmapFilterMode, [ :CUtexref, :CUfilter_mode ], :CUresult
  attach_function :cuTexRefSetMipmapLevelBias, :cuTexRefSetMipmapLevelBias, [ :CUtexref, :float ], :CUresult
  attach_function :cuTexRefSetMipmapLevelClamp, :cuTexRefSetMipmapLevelClamp, [ :CUtexref, :float, :float ], :CUresult
  attach_function :cuTexRefSetMaxAnisotropy, :cuTexRefSetMaxAnisotropy, [ :CUtexref, :uint ], :CUresult
  attach_function :cuTexRefSetBorderColor, :cuTexRefSetBorderColor, [ :CUtexref, :pointer ], :CUresult
  attach_function :cuTexRefSetFlags, :cuTexRefSetFlags, [ :CUtexref, :uint ], :CUresult
  attach_function :cuTexRefGetAddress_v2, :cuTexRefGetAddress_v2, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetArray, :cuTexRefGetArray, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetMipmappedArray, :cuTexRefGetMipmappedArray, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetAddressMode, :cuTexRefGetAddressMode, [ :pointer, :CUtexref, :int ], :CUresult
  attach_function :cuTexRefGetFilterMode, :cuTexRefGetFilterMode, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetFormat, :cuTexRefGetFormat, [ :pointer, :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetMipmapFilterMode, :cuTexRefGetMipmapFilterMode, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetMipmapLevelBias, :cuTexRefGetMipmapLevelBias, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetMipmapLevelClamp, :cuTexRefGetMipmapLevelClamp, [ :pointer, :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetMaxAnisotropy, :cuTexRefGetMaxAnisotropy, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetBorderColor, :cuTexRefGetBorderColor, [ :pointer, :CUtexref ], :CUresult
  attach_function :cuTexRefGetFlags, :cuTexRefGetFlags, [ :pointer, :CUtexref ], :CUresult
  ...
  attach_function :cuSurfRefSetArray, :cuSurfRefSetArray, [ :CUsurfref, :CUarray, :uint ], :CUresult
  attach_function :cuSurfRefGetArray, :cuSurfRefGetArray, [ :pointer, :CUsurfref ], :CUresult
  attach_function :cuTexObjectCreate, :cuTexObjectCreate, [ :pointer, :pointer, :pointer, :pointer ], :CUresult
  attach_function :cuTexObjectDestroy, :cuTexObjectDestroy, [ :CUtexObject ], :CUresult
  attach_function :cuTexObjectGetResourceDesc, :cuTexObjectGetResourceDesc, [ :pointer, :CUtexObject ], :CUresult
  attach_function :cuTexObjectGetTextureDesc, :cuTexObjectGetTextureDesc, [ :pointer, :CUtexObject ], :CUresult
  attach_function :cuTexObjectGetResourceViewDesc, :cuTexObjectGetResourceViewDesc, [ :pointer, :CUtexObject ], :CUresult
  attach_function :cuSurfObjectCreate, :cuSurfObjectCreate, [ :pointer, :pointer ], :CUresult
  attach_function :cuSurfObjectDestroy, :cuSurfObjectDestroy, [ :CUsurfObject ], :CUresult
  attach_function :cuSurfObjectGetResourceDesc, :cuSurfObjectGetResourceDesc, [ :pointer, :CUsurfObject ], :CUresult
  attach_function :cuDeviceCanAccessPeer, :cuDeviceCanAccessPeer, [ :pointer, :CUdevice, :CUdevice ], :CUresult
  attach_function :cuCtxEnablePeerAccess, :cuCtxEnablePeerAccess, [ :CUcontext, :uint ], :CUresult
  attach_function :cuCtxDisablePeerAccess, :cuCtxDisablePeerAccess, [ :CUcontext ], :CUresult
  attach_function :cuDeviceGetP2PAttribute, :cuDeviceGetP2PAttribute, [ :pointer, :CUdevice_P2PAttribute, :CUdevice, :CUdevice ], :CUresult
  attach_function :cuGraphicsUnregisterResource, :cuGraphicsUnregisterResource, [ :CUgraphicsResource ], :CUresult
  attach_function :cuGraphicsSubResourceGetMappedArray, :cuGraphicsSubResourceGetMappedArray, [ :pointer, :CUgraphicsResource, :uint, :uint ], :CUresult
  attach_function :cuGraphicsResourceGetMappedMipmappedArray, :cuGraphicsResourceGetMappedMipmappedArray, [ :pointer, :CUgraphicsResource ], :CUresult
  attach_function :cuGraphicsResourceGetMappedPointer_v2, :cuGraphicsResourceGetMappedPointer_v2, [ :pointer, :pointer, :CUgraphicsResource ], :CUresult
  attach_function :cuGraphicsResourceSetMapFlags_v2, :cuGraphicsResourceSetMapFlags_v2, [ :CUgraphicsResource, :uint ], :CUresult
  attach_function :cuGraphicsMapResources, :cuGraphicsMapResources, [ :uint, :pointer, :CUstream ], :CUresult
  attach_function :cuGraphicsUnmapResources, :cuGraphicsUnmapResources, [ :uint, :pointer, :CUstream ], :CUresult
  attach_function :cuGetProcAddress, :cuGetProcAddress, [ :string, :pointer, :int, :cuuint64_t ], :CUresult
  attach_function :cuGetExportTable, :cuGetExportTable, [ :pointer, :pointer ], :CUresult
  end
end
