...
module Cuda
  module DriverApi
    ...
    attach_function :cuFlushGPUDirectRDMAWrites, %i[CUflushGPUDirectRDMAWritesTarget CUflushGPUDirectRDMAWritesScope],
                    :CUresult
    ...
    attach_function :cuLinkAddData, %i[CUlinkState CUjitInputType pointer size_t pointer unsigned_int pointer pointer],
                    :CUresult
    ...
    attach_function :cuOccupancyMaxPotentialBlockSize, %i[pointer pointer CUfunction CUoccupancyB2DSize size_t int],
                    :CUresult
